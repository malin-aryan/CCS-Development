<?php
/*
 * Template Name: Correctional Projects page Template
 * description: >-
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="w-100 InnerTop mbot_50">
              <h2 class="t-center x30 pbot_20">CCS  Correctional Projects</h2>
              <p class="text-center x16">
                CCS  Correctional Projects
            </p>
            </div>
          </div>
        </div>
        <div class="row">
          ...
          <div class="col-md-12">
            <div class="w-100 InnerBot">
              <h3> CCS Correctional Projects</h3>
